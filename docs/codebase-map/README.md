...
Generated 2026-09-19T22:37:24.706Z by `tools/generate-codebase-map.mjs`. Regenerate with:
...
| `apps/api/src/rag.ts` | ts | 1634 |  | const EMBEDDING_MODEL, type AyahRecord, type AskRecord, type AskScope, type RagSource, function extractAnswerText, +20 more |
...
| verses | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts`, `apps/api/test/ask-quran-sources.test.ts` |
