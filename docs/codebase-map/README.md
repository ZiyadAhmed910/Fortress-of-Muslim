...
Generated 2026-09-24T14:54:24.636Z by `tools/generate-codebase-map.mjs`. Regenerate with:
...
- **ask_query_log** (table) — defined in `apps/api/migrations/0027_ask_query_log.sql`, only referenced by `apps/api/src/rag.ts`
...
- **canonical_search_aliases** (table) — defined in `apps/api/migrations/0020_search_aliases.sql`, only referenced by `apps/api/src/rag.ts`
...
- **quran_search_fts** (virtual_table) — defined in `apps/api/migrations/0024_quran_search.sql`, only referenced by `apps/api/src/quran-search.ts`
...
| --- | --- | --- | --- | --- |
| `apps/admin/public/app.js` | js | 1558 |  |  |
...
| `apps/api/migrations/0024_quran_search.sql` | sql | 55 |  |  |
...
| `apps/api/migrations/0029_media_daily_stats.sql` | sql | 30 |  |  |
...
| `apps/api/src/lib/hisn-chapters.ts` | ts | 25 |  | const HISN_CHAPTER_BY_READING, function hisnChapterForReading |
...
| `apps/api/src/rag.ts` | ts | 1686 |  | const EMBEDDING_MODEL, type AyahRecord, type AskRecord, type AskScope, type RagSource, function extractAnswerText, +20 more |
...
| `apps/api/src/repositories/d1-content-repository.ts` | ts | 760 |  | class D1ContentRepository |
...
| `apps/media/src/index.ts` | ts | 128 | 1 | interface Env, type Kind, function countAs, function keyFor, function tally, default export |
| `apps/media/test/media.test.ts` | ts | 137 |  |  |
...
| `pwa-website/js/calendar.js` | js | 158 |  |  |
| `pwa-website/js/categories.js` | js | 150 |  |  |
| `pwa-website/js/constants.js` | js | 3 |  |  |
| `pwa-website/js/data.js` | js | 13 |  |  |
| `pwa-website/js/dom.js` | js | 180 |  |  |
| `pwa-website/js/dua-audio.js` | js | 289 |  |  |
| `pwa-website/js/filters.js` | js | 25 |  |  |
| `pwa-website/js/hadith.js` | js | 160 |  |  |
| `pwa-website/js/hijri.js` | js | 266 |  |  |
| `pwa-website/js/home.js` | js | 218 |  |  |
| `pwa-website/js/layout.js` | js | 15 |  |  |
| `pwa-website/js/modes.js` | js | 85 |  |  |
| `pwa-website/js/onboarding.js` | js | 182 |  |  |
| `pwa-website/js/online.js` | js | 22 |  |  |
| `pwa-website/js/prayer-times.js` | js | 344 |  |  |
| `pwa-website/js/prayer.js` | js | 610 |  |  |
| `pwa-website/js/pwa.js` | js | 146 |  |  |
| `pwa-website/js/quran-audio.js` | js | 633 |  |  |
| `pwa-website/js/quran-juz.js` | js | 72 |  |  |
| `pwa-website/js/quran-verse-search.js` | js | 91 |  |  |
| `pwa-website/js/quran.js` | js | 999 |  |  |
| `pwa-website/js/reader.js` | js | 148 |  |  |
| `pwa-website/js/reminders.js` | js | 221 |  |  |
| `pwa-website/js/routes.js` | js | 63 |  |  |
| `pwa-website/js/seo.js` | js | 70 |  |  |
| `pwa-website/js/settings.js` | js | 183 |  |  |
| `pwa-website/js/sky.js` | js | 259 |  |  |
| `pwa-website/js/state.js` | js | 48 |  |  |
| `pwa-website/js/storage.js` | js | 133 |  |  |
| `pwa-website/js/tasbih.js` | js | 205 |  |  |
| `pwa-website/js/userData.js` | js | 160 |  |  |
| `pwa-website/js/utils.js` | js | 33 |  |  |
| `pwa-website/sw.js` | js | 269 |  |  |
| `pwa-website/test/ask-scroll.test.js` | js | 92 |  |  |
| `pwa-website/test/boot-theme.test.js` | js | 103 |  |  |
| `pwa-website/test/calendar.test.js` | js | 43 |  |  |
...
| `pwa-website/test/hijri.test.js` | js | 261 |  |  |
...
| `pwa-website/test/quran-juz.test.js` | js | 111 |  |  |
...
| GET | `/` | hono | `apps/api/src/app.ts:142` |
| (any) | `/.well-known/oauth-protected-resource` | manual (exact) | `apps/mcp/src/index.ts:38` |
| (any) | `/^\/v1\/admin\/access-requests\/([^/]+` | manual (pattern) | `apps/auth/src/admin-plane.ts:185` |
| (any) | `/^\/v1\/admin\/alerts\/([^/]+` | manual (pattern) | `apps/auth/src/admin-plane.ts:179` |
...
| (any) | `/^\/v1\/admin\/rate-limits\/([a-z-]+` | manual (pattern) | `apps/auth/src/admin-plane.ts:165` |
| (any) | `/^\/v1\/admin\/services\/([a-z-]+` | manual (pattern) | `apps/auth/src/admin-plane.ts:159` |
| (any) | `/^\/v1\/admin\/sessions\/([^/]+` | manual (pattern) | `apps/auth/src/admin-plane.ts:154` |
| (any) | `/^\/v1\/admin\/users\/([^/]+` | manual (pattern) | `apps/auth/src/admin-plane.ts:147` |
...
| GET | `/health` | hono | `apps/api/src/app.ts:151` |
| (any) | `/health` | manual (exact) | `apps/auth/src/index.ts:52` |
| (any) | `/health` | manual (exact) | `apps/mcp/src/index.ts:37` |
| (any) | `/health` | manual (exact) | `apps/media/src/index.ts:88` |
| GET | `/health/database` | hono | `apps/api/src/app.ts:159` |
| GET | `/v1` | hono | `apps/api/src/app.ts:197` |
| USE | `/v1/*` | hono | `apps/api/src/app.ts:140` |
| USE | `/v1/*` | hono | `apps/api/src/app.ts:172` |
...
| GET | `/v1/admin/access-requests` | manual (exact) | `apps/auth/src/admin-plane.ts:145` |
| GET | `/v1/admin/alerts` | manual (exact) | `apps/auth/src/admin-plane.ts:142` |
| GET | `/v1/admin/ask-controls` | manual (exact) | `apps/auth/src/admin-plane.ts:136` |
| PATCH | `/v1/admin/ask-controls` | manual (exact) | `apps/auth/src/admin-plane.ts:137` |
| GET | `/v1/admin/audit` | manual (exact) | `apps/auth/src/admin-plane.ts:141` |
...
| GET | `/v1/admin/media-stats` | manual (exact) | `apps/auth/src/admin-plane.ts:144` |
...
| GET | `/v1/admin/rate-limits` | manual (exact) | `apps/auth/src/admin-plane.ts:143` |
...
| POST | `/v1/ask` | hono | `apps/api/src/app.ts:444` |
| GET | `/v1/ask/status` | hono | `apps/api/src/app.ts:527` |
| POST | `/v1/ask/stream` | hono | `apps/api/src/app.ts:471` |
| GET | `/v1/collections` | hono | `apps/api/src/app.ts:231` |
...
| GET | `/v1/datasets/current` | hono | `apps/api/src/app.ts:216` |
| GET | `/v1/duas` | hono | `apps/api/src/app.ts:241` |
| GET | `/v1/duas/:id` | hono | `apps/api/src/app.ts:370` |
| GET | `/v1/duas/:id/evidence` | hono | `apps/api/src/app.ts:321` |
| GET | `/v1/duas/:id/parts` | hono | `apps/api/src/app.ts:327` |
| GET | `/v1/duas/:id/parts/:position` | hono | `apps/api/src/app.ts:341` |
| GET | `/v1/duas/random` | hono | `apps/api/src/app.ts:305` |
| GET | `/v1/duas/search` | hono | `apps/api/src/app.ts:274` |
| GET | `/v1/hadith` | hono | `apps/api/src/app.ts:385` |
| GET | `/v1/hadith/:id` | hono | `apps/api/src/app.ts:438` |
| GET | `/v1/hadith/resolve` | hono | `apps/api/src/app.ts:420` |
| GET | `/v1/hadith/search` | hono | `apps/api/src/app.ts:402` |
| POST | `/v1/internal/vector-index` | hono | `apps/api/src/app.ts:533` |
| GET | `/v1/oauth/client-name` | manual (exact) | `apps/auth/src/index.ts:71` |
| GET | `/v1/queries/:id` | hono | `apps/api/src/app.ts:544` |
| USE | `/v1/queries/*` | hono | `apps/api/src/app.ts:109` |
| GET | `/v1/quran/search` | hono | `apps/api/src/app.ts:500` |
| GET | `/v1/quran/status` | hono | `apps/api/src/app.ts:524` |

## Schema (tables/views -> referencing files)

| Name | Kind | Defined in | Referenced by (excl. definer) |
| --- | --- | --- | --- |
| _m0018_eligible | table | `apps/api/migrations/0018_hisn_reading_roles.sql` | (none) |
...
| a | unknown | `(not defined in scanned files)` | `apps/admin/public/app.js`, `apps/api/src/rag.ts`, `apps/api/test/ask-follow-up.test.ts`, `apps/api/test/ask-policy.test.ts`, `apps/api/test/dua-canonical-url.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/api/test/record-query.test.ts`, `apps/auth/src/admin-plane.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/src/index.ts`, `apps/media/src/index.ts`, `apps/media/test/media.test.ts`, `pwa-website/js/dua-audio.js`, `pwa-website/js/layout.js`, `pwa-website/js/prayer.js`, `pwa-website/js/quran-audio.js`, `pwa-website/js/reminders.js`, `pwa-website/js/sky.js`, `pwa-website/js/userData.js`, `pwa-website/sw.js`, `pwa-website/test/deep-links.test.js`, `pwa-website/test/sky.test.js` |
...
| an | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts`, `pwa-website/js/prayer-times.js`, `pwa-website/js/prayer.js` |
| another | unknown | `(not defined in scanned files)` | `pwa-website/js/seo.js` |
| any | unknown | `(not defined in scanned files)` | `apps/admin/public/app.js`, `pwa-website/test/hijri.test.js` |
| anyway | unknown | `(not defined in scanned files)` | `pwa-website/js/storage.js` |
...
| ask_query_log | table | `apps/api/migrations/0027_ask_query_log.sql` | `apps/api/src/rag.ts` |
| ask_settings | table | `apps/api/migrations/0019_ask_controls.sql` | `apps/api/src/rag.ts`, `apps/api/test/ask-policy.test.ts`, `apps/auth/src/admin-plane.ts` |
...
| banner | unknown | `(not defined in scanned files)` | `pwa-website/sw.js`, `pwa-website/test/install-affordance.test.js` |
| before | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts`, `pwa-website/js/userData.js` |
| books | table | `apps/api/migrations/0003_canonical_knowledge.sql` | `apps/api/src/lib/record-query.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/dua-canonical-url.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/api/test/record-query.test.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/test/editorial-pilot.test.ts` |
...
| canonical_dataset_items | table | `apps/api/migrations/0008_publication_snapshots.sql` | `apps/api/src/rag.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/test/editorial-pilot.test.ts` |
| canonical_dataset_versions | table | `apps/api/test/search-aliases.test.ts`, `apps/api/migrations/0006_canonical_editorial.sql` | `apps/api/src/rag.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/arabic-search.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/rag-filters.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/editorial-plane.ts` |
| canonical_publication_history | table | `apps/api/migrations/0006_canonical_editorial.sql` | `apps/auth/src/editorial-plane.ts` |
| canonical_publications | table | `apps/api/test/search-aliases.test.ts`, `apps/api/migrations/0006_canonical_editorial.sql` | `apps/api/src/rag.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/arabic-search.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/rag-filters.test.ts`, `apps/api/test/rag-index.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/admin-plane.ts`, `apps/auth/src/editorial-plane.ts` |
| canonical_reading_roles | table | `apps/api/migrations/0018_hisn_reading_roles.sql` | `apps/api/src/repositories/d1-content-repository.ts` |
| canonical_records | table | `apps/api/test/search-aliases.test.ts`, `apps/api/migrations/0006_canonical_editorial.sql` | `apps/api/src/lib/record-query.ts`, `apps/api/src/rag.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/arabic-search.test.ts`, `apps/api/test/dua-canonical-url.test.ts`, `apps/api/test/hadith-reference.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/rag-filters.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/api/test/record-query.test.ts`, `apps/auth/src/admin-plane.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/test/editorial-pilot.test.ts` |
| canonical_references | table | `apps/api/migrations/0006_canonical_editorial.sql` | `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/test/editorial-pilot.test.ts` |
| canonical_search_aliases | table | `apps/api/migrations/0020_search_aliases.sql` | `apps/api/src/rag.ts` |
| canonical_search_fts | virtual_table | `apps/api/test/record-query.test.ts`, `apps/api/test/record-query.test.ts`, `apps/api/test/search-aliases.test.ts`, `apps/auth/test/editorial-pilot.test.ts`, `apps/auth/test/editorial-pilot.test.ts`, `apps/api/migrations/0006_canonical_editorial.sql` | `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/arabic-search.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/rag-filters.test.ts`, `apps/auth/src/editorial-plane.ts` |
| canonical_withdrawals | table | `apps/api/test/search-aliases.test.ts`, `apps/api/migrations/0017_canonical_withdrawals.sql` | `apps/api/src/rag.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/canonical-withdrawal.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/reading-roles-migration.test.ts` |
| chapters | table | `apps/api/migrations/0003_canonical_knowledge.sql` | `apps/api/src/lib/record-query.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/dua-canonical-url.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/test/editorial-pilot.test.ts` |
| cited | unknown | `(not defined in scanned files)` | `apps/api/src/quran-search.ts` |
| Cloudflare | unknown | `(not defined in scanned files)` | `pwa-website/edge/worker.js` |
| collections | table | `apps/api/test/search-aliases.test.ts`, `apps/api/migrations/0003_canonical_knowledge.sql` | `apps/api/src/lib/record-query.ts`, `apps/api/src/rag.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/dua-canonical-url.test.ts`, `apps/api/test/hadith-reference.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/rag-filters.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/api/test/record-query.test.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/test/editorial-pilot.test.ts` |
...
| content_parts | table | `apps/api/migrations/0001_content_schema.sql` | `apps/api/test/canonical-withdrawal.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/editorial-plane.ts` |
| content_records | table | `apps/api/migrations/0001_content_schema.sql` | `apps/api/test/arabic-search.test.ts`, `apps/api/test/canonical-withdrawal.test.ts`, `apps/api/test/hadith-reference.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/rag-filters.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/api/test/record-query.test.ts`, `apps/auth/src/editorial-plane.ts` |
| content_revisions | table | `apps/api/test/search-aliases.test.ts`, `apps/api/migrations/0006_canonical_editorial.sql` | `apps/api/src/lib/record-query.ts`, `apps/api/src/rag.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/arabic-search.test.ts`, `apps/api/test/canonical-withdrawal.test.ts`, `apps/api/test/dua-canonical-url.test.ts`, `apps/api/test/hadith-reference.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/rag-filters.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/api/test/record-query.test.ts`, `apps/auth/src/admin-plane.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/test/editorial-pilot.test.ts` |
...
| content_segments | table | `apps/api/migrations/0001_content_schema.sql` | `apps/api/test/canonical-withdrawal.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/editorial-plane.ts` |
| contributors | table | `apps/api/migrations/0003_canonical_knowledge.sql` | (none) |
| correction_history | table | `apps/api/migrations/0003_canonical_knowledge.sql` | `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/test/editorial-pilot.test.ts` |
| cross_references | table | `apps/api/migrations/0003_canonical_knowledge.sql` | (none) |
| curated | unknown | `(not defined in scanned files)` | `pwa-website/test/categories.test.js` |
| D1 | unknown | `(not defined in scanned files)` | `apps/media/src/index.ts` |
| dataset_sources | table | `apps/api/migrations/0003_canonical_knowledge.sql` | (none) |
| dataset_versions | table | `apps/api/migrations/0001_content_schema.sql` | `apps/api/test/canonical-withdrawal.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/editorial-plane.ts` |
...
| development | unknown | `(not defined in scanned files)` | `pwa-website/test/edge-worker.test.js` |
...
| every | unknown | `(not defined in scanned files)` | `apps/api/test/canonical-withdrawal.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/test/admin-mfa-gate.test.ts`, `pwa-website/js/hadith.js`, `pwa-website/js/onboarding.js` |
| everyayah | unknown | `(not defined in scanned files)` | `pwa-website/js/quran-audio.js` |
| evidence | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts` |
| evil | unknown | `(not defined in scanned files)` | `apps/api/test/ask-policy.test.ts`, `apps/api/test/search-aliases.test.ts` |
...
| filters | unknown | `(not defined in scanned files)` | `apps/api/test/ask-scope.test.ts` |
| fitAssistantHeight | unknown | `(not defined in scanned files)` | `pwa-website/js/assistant.js` |
| for | unknown | `(not defined in scanned files)` | `pwa-website/js/quran.js`, `pwa-website/sw.js` |
...
| here | unknown | `(not defined in scanned files)` | `pwa-website/js/prayer-times.js` |
| HIJRI_MONTHS | unknown | `(not defined in scanned files)` | `pwa-website/js/hijri.js` |
| Hisn | unknown | `(not defined in scanned files)` | `pwa-website/edge/pages.js` |
| index | unknown | `(not defined in scanned files)` | `pwa-website/test/boot-theme.test.js` |
| Intl | unknown | `(not defined in scanned files)` | `pwa-website/js/hijri.js` |
...
| media_daily_stats | table | `apps/api/migrations/0029_media_daily_stats.sql` | `apps/api/test/media-stats.test.ts`, `apps/auth/src/admin-plane.ts`, `apps/media/src/index.ts` |
| member | table | `apps/auth/migrations/0001_identity.sql` | (none) |
| memory | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts` |
| metal | unknown | `(not defined in scanned files)` | `pwa-website/js/prayer.js` |
| model | unknown | `(not defined in scanned files)` | `pwa-website/edge/worker.js`, `pwa-website/test/edge-worker.test.js` |
...
| negative | unknown | `(not defined in scanned files)` | `pwa-website/js/sky.js` |
| network | unknown | `(not defined in scanned files)` | `pwa-website/test/sw-navigation.test.js` |
| north | unknown | `(not defined in scanned files)` | `pwa-website/js/prayer.js` |
| nothing | unknown | `(not defined in scanned files)` | `apps/api/test/ask-scope.test.ts` |
...
| of | unknown | `(not defined in scanned files)` | `pwa-website/test/hijri.test.js` |
...
| our | unknown | `(not defined in scanned files)` | `pwa-website/js/dua-audio.js`, `pwa-website/js/quran-juz.js`, `pwa-website/sw.js` |
| passkey | table | `apps/auth/migrations/0008_account_security.sql` | (none) |
| paths | unknown | `(not defined in scanned files)` | `pwa-website/test/deep-links.test.js` |
...
| pretending | unknown | `(not defined in scanned files)` | `pwa-website/js/hijri.js` |
| production | unknown | `(not defined in scanned files)` | `pwa-website/js/dua-audio.js`, `pwa-website/test/dua-audio.test.js` |
...
| pwa | unknown | `(not defined in scanned files)` | `apps/api/src/lib/hisn-chapters.ts`, `apps/api/src/repositories/d1-content-repository.ts` |
| quran | unknown | `(not defined in scanned files)` | `pwa-website/test/quran-words.test.js` |
| quran_ayahs | table | `apps/api/migrations/0024_quran_search.sql` | `apps/api/src/quran-search.ts`, `apps/api/test/quran-search.test.ts` |
| quran_index_state | table | `apps/api/migrations/0024_quran_search.sql` | `apps/api/src/quran-search.ts`, `apps/api/test/quran-search.test.ts` |
| quran_search_fts | virtual_table | `apps/api/migrations/0024_quran_search.sql` | `apps/api/src/quran-search.ts` |
| R2 | unknown | `(not defined in scanned files)` | `apps/media/src/index.ts` |
| rag_daily_usage | table | `apps/api/migrations/0005_rag_usage.sql` | `apps/api/src/rag.ts`, `apps/auth/src/admin-plane.ts` |
| rag_index_state | table | `apps/api/test/search-aliases.test.ts`, `apps/api/migrations/0007_rag_index_state.sql` | `apps/api/src/rag.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/admin-plane.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/test/editorial-pilot.test.ts` |
| rate_limit_counters | table | `apps/auth/migrations/0010_rate_limits.sql` | `apps/auth/src/index.ts` |
| reading | unknown | `(not defined in scanned files)` | `pwa-website/test/dua-audio.test.js` |
| record_numberings | table | `apps/api/migrations/0004_corpus_ingestion.sql` | (none) |
| record_placements | table | `apps/api/migrations/0003_canonical_knowledge.sql` | `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/dua-canonical-url.test.ts`, `apps/auth/src/editorial-plane.ts` |
...
| retrieved | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts` |
...
| revision_metadata | table | `apps/api/test/search-aliases.test.ts`, `apps/api/migrations/0006_canonical_editorial.sql` | `apps/api/src/lib/record-query.ts`, `apps/api/src/rag.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/hadith-reference.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/rag-filters.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/api/test/record-query.test.ts`, `apps/auth/src/editorial-plane.ts` |
| revision_parts | table | `apps/api/test/search-aliases.test.ts`, `apps/api/migrations/0006_canonical_editorial.sql` | `apps/api/src/lib/record-query.ts`, `apps/api/src/rag.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/canonical-withdrawal.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/rag-filters.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/editorial-plane.ts` |
| revision_segments | table | `apps/api/test/search-aliases.test.ts`, `apps/api/migrations/0006_canonical_editorial.sql` | `apps/api/src/rag.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/canonical-withdrawal.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/rag-filters.test.ts`, `apps/api/test/reading-roles-migration.test.ts`, `apps/auth/src/editorial-plane.ts` |
| Ruqyah | unknown | `(not defined in scanned files)` | `pwa-website/test/categories.test.js` |
| screen | unknown | `(not defined in scanned files)` | `pwa-website/test/card-labels.test.js` |
| segment_translations | table | `apps/api/migrations/0003_canonical_knowledge.sql` | (none) |
| service | unknown | `(not defined in scanned files)` | `apps/api/test/publish-hadith-migration.test.ts` |
| session | table | `apps/auth/migrations/0001_identity.sql` | `apps/auth/src/admin-plane.ts` |
| SET | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts`, `apps/api/test/dua-canonical-url.test.ts`, `apps/auth/src/admin-plane.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/src/index.ts`, `apps/media/src/index.ts` |
...
| six | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts` |
| solar | unknown | `(not defined in scanned files)` | `pwa-website/js/prayer-times.js` |
| something | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts`, `apps/api/test/ask-follow-up.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `packages/contracts/src/index.ts` |
...
| sources | unknown | `(not defined in scanned files)` | `apps/api/test/ask-follow-up.test.ts` |
...
| Surah | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts` |
...
| that | unknown | `(not defined in scanned files)` | `pwa-website/js/prayer-times.js`, `pwa-website/test/guide-and-tasbih.test.js`, `pwa-website/test/sw-navigation.test.js`, `pwa-website/test/worship-nav.test.js` |
| the | unknown | `(not defined in scanned files)` | `apps/admin/public/app.js`, `apps/api/src/app.ts`, `apps/api/src/quran-search.ts`, `apps/api/src/rag-intent.ts`, `apps/api/src/rag.ts`, `apps/api/src/repositories/d1-content-repository.ts`, `apps/api/test/ask-citations.test.ts`, `apps/api/test/ask-policy.test.ts`, `apps/api/test/ask-quran-sources.test.ts`, `apps/api/test/ask-scope.test.ts`, `apps/api/test/canonical-withdrawal.test.ts`, `apps/api/test/dua-canonical-url.test.ts`, `apps/api/test/publish-hadith-migration.test.ts`, `apps/api/test/quran-search.test.ts`, `apps/api/test/search-aliases.test.ts`, `apps/auth/src/admin-plane.ts`, `apps/auth/src/editorial-plane.ts`, `apps/auth/test/editorial-pilot.test.ts`, `apps/developers/public/console.js`, `apps/status/public/app.js`, `pwa-website/edge/pages.js`, `pwa-website/edge/worker.js`, `pwa-website/js/app.js`, `pwa-website/js/assistant.js`, `pwa-website/js/calendar.js`, `pwa-website/js/categories.js`, `pwa-website/js/dua-audio.js`, `pwa-website/js/hijri.js`, `pwa-website/js/onboarding.js`, `pwa-website/js/prayer-times.js`, `pwa-website/js/prayer.js`, `pwa-website/js/quran-audio.js`, `pwa-website/js/quran-verse-search.js`, `pwa-website/js/quran.js`, `pwa-website/js/seo.js`, `pwa-website/js/sky.js`, `pwa-website/js/state.js`, `pwa-website/js/storage.js`, `pwa-website/sw.js`, `pwa-website/test/boot-theme.test.js`, `pwa-website/test/calendar.test.js`, `pwa-website/test/categories.test.js`, `pwa-website/test/dua-audio.test.js`, `pwa-website/test/edge-pages.test.js`, `pwa-website/test/guide-and-tasbih.test.js`, `pwa-website/test/hijri.test.js`, `pwa-website/test/prayer-times.test.js`, `pwa-website/test/qibla-compass.test.js`, `pwa-website/test/quran-juz.test.js`, `pwa-website/test/quran-words.test.js`, `pwa-website/test/reading-roles.test.js`, `pwa-website/test/sky.test.js`, `pwa-website/test/storage.test.js`, `pwa-website/test/worship-nav.test.js` |
| there | unknown | `(not defined in scanned files)` | `pwa-website/js/assistant.js`, `pwa-website/js/quran.js`, `pwa-website/test/quran-bismillah.test.js` |
| these | unknown | `(not defined in scanned files)` | `pwa-website/edge/pages.js` |
| this | unknown | `(not defined in scanned files)` | `apps/auth/src/editorial-plane.ts`, `apps/status/public/app.js`, `pwa-website/js/calendar.js`, `pwa-website/js/quran-verse-search.js`, `pwa-website/js/quran.js`, `pwa-website/sw.js`, `pwa-website/test/calendar.test.js` |
| those | unknown | `(not defined in scanned files)` | `pwa-website/js/prayer-times.js` |
| travel | unknown | `(not defined in scanned files)` | `apps/api/test/ask-follow-up.test.ts`, `apps/api/test/fuzzy-title.test.ts` |
...
| Umm | unknown | `(not defined in scanned files)` | `pwa-website/js/hijri.js` |
...
| verses | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts`, `apps/api/test/ask-quran-sources.test.ts`, `apps/api/test/ask-scope.test.ts` |
...
| whatever | unknown | `(not defined in scanned files)` | `apps/api/src/rag.ts`, `apps/api/test/ask-quran-sources.test.ts`, `pwa-website/js/prayer.js` |
| where | unknown | `(not defined in scanned files)` | `pwa-website/js/modes.js` |
| wherever | unknown | `(not defined in scanned files)` | `pwa-website/test/qibla-compass.test.js` |
| your | unknown | `(not defined in scanned files)` | `pwa-website/js/calendar.js`, `pwa-website/test/calendar.test.js` |
