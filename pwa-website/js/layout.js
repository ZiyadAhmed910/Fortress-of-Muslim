// Prayer Times, Qibla, Tasbih and the Islamic calendar sit behind one "Prayer" button on the nav,
// which opens a sub-bar for them. That grouping is how the nav is shaped rather than a setting
// anyone toggles -- which is why it is all that is left in this file -- but it is still a decision:
// the calendar joined in 0.46.0 because it is a time tool used the same way the others are, glanced
// at rather than read. A fifth member should be as deliberate a choice as that one was.
//
...
export const WORSHIP_TABS = ['prayerTimes', 'qibla', 'tasbih', 'calendar'];
