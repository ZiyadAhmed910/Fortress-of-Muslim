...
function importUserData(payload) {
  ...
  // payload.layout, from a backup made while Customize Layout existed, is deliberately ignored:
  // there is nothing left for it to configure, and every tab is present for everyone.
