export const els = {
  ...
  storageSection: document.getElementById('storageSection'),
  storageTotal: document.getElementById('storageTotal'),
  storageList: document.getElementById('storageList'),
  duaAudioDownloadRow: document.getElementById('duaAudioDownloadRow'),
  duaAudioDownloadStatus: document.getElementById('duaAudioDownloadStatus'),
  duaAudioDownloadButton: document.getElementById('duaAudioDownloadButton'),
  ...
  calendarHome: document.getElementById('calendarHome'),
  calendarToday: document.getElementById('calendarToday'),
  calendarHijri: document.getElementById('calendarHijri'),
  calendarGregorian: document.getElementById('calendarGregorian'),
  calendarNext: document.getElementById('calendarNext'),
  calendarNextName: document.getElementById('calendarNextName'),
  calendarNextWhen: document.getElementById('calendarNextWhen'),
  calendarHeading: document.querySelector('#calendarHome .calendar-heading'),
  ...
  duaAudio: document.getElementById('duaAudio'),
